                ...
                <section className="font-['raleway']">
                    ...
                    <div className="flex items-center justify-center py-4 sm:py-6 lg:py-6">
                        <div className="w-full max-w-sm xl:max-w-md">
                            <h2 className="mt-4 text-2xl sm:text-3xl font-bold leading-tight text-teal-400 text-center">Specialist's Registration</h2>
                            <p className="mt-3 text-sm sm:text-base text-white text-center">
                                Already have an account?{' '}
                                <Link to="/Specialist-login" title="" className="font-bold text-teal-400 transition-all duration-200 hover:underline">
                                    Sign In
                                </Link>
                            </p>
